...
MODELO_FABRICANTE decimal(18,0) FOREIGN KEY REFERENCES gd_esquema.Fabricante(FABRICANTE_ID)
);
...
OPERACION_TIPO decimal(1,0) FOREIGN KEY REFERENCES gd_esquema.Tipo_Operacion(TIPO_OPERACION_ID),
OPERACION_FECHA datetime2(3),
OPERACION_SUCURSAL decimal(18,0) FOREIGN KEY REFERENCES gd_esquema.Sucursal(SUCURSAL_ID),
OPERACION_CLIENTE decimal(18,0) FOREIGN KEY REFERENCES gd_esquema.Cliente(CLIENTE_ID),
...
ITEM_AUTO_ID decimal(18,0) FOREIGN KEY REFERENCES gd_esquema.Auto(AUTO_ID),
ITEM_AUTO_PARTE_ID decimal(18,0) FOREIGN KEY REFERENCES gd_esquema.Auto_Parte(AUTO_PARTE_CODIGO),
