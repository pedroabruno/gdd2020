...
ITEM_PRECIO decimal(18,2) NOT NULL,
FOREIGN KEY (ITEM_NRO) REFERENCES gd_esquema.Compra(COMPRA_NRO),
CONSTRAINT FK_ITEM_COMPRA_AUTOPARTE FOREIGN KEY (ITEM_AUTOPARTE_ID) REFERENCES gd_esquema.Auto_Parte(AUTO_PARTE_CODIGO)
);
...
ITEM_CANTIDAD decimal(18,0) DEFAULT 1,
ITEM_PRECIO decimal(18,2) NOT NULL,
FOREIGN KEY (ITEM_NRO) REFERENCES gd_esquema.Factura(FACTURA_NRO),
...
ITEM_PRECIO decimal(18,2) NOT NULL,
FOREIGN KEY (ITEM_NRO) REFERENCES gd_esquema.Factura(FACTURA_NRO),
CONSTRAINT FK_ITEM_FACTURA_AUTOPARTE FOREIGN KEY (ITEM_AUTOPARTE_ID) REFERENCES gd_esquema.Auto_Parte(AUTO_PARTE_CODIGO)
);
