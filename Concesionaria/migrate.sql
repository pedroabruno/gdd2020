...
CREATE INDEX IX_CLIENTE_DNI ON NAPOLITANA_CON_FRITAS.Cliente(CLIENTE_DNI);
...
begin
	...
	select 
		(select CLIENTE_ID from NAPOLITANA_CON_FRITAS.Cliente c where c.CLIENTE_APELLIDO = t.CLIENTE_APELLIDO and c.CLIENTE_DNI = t.CLIENTE_DNI and c.CLIENTE_MAIL = t.CLIENTE_MAIL) cliente,
		COMPRA_NRO,
		COMPRA_FECHA,
